...
menu.display = function()	
	...
	local assigned, assigned2, unassigned, active, inactive = {}, {}, {}, {}, {}
...
--	if #menu.ship.assigned_ships > 0 then
	...
	if isExpanded then
		for _,ship in ipairs(menu.ship.assigned_ships or {}) do
			...
			if ship[8] == 3 then activity = "Stopped" end
...
Availability.Remove = function(menu, rowIdx, rowData)
	...
	return rowData[1] == "active" and (rowData[2][8] < 1 or rowData[2][8] > 2)
end
...
Availability.Start = function(menu, rowIdx, rowData)
	...
	return rowData[1] == "active" and rowData[2][3] ~= "none" and rowData[2][11] > 1 and (rowData[2][8] < 1 or rowData[2][8] > 2) and menu.ship.hascaptain
end

-- Availability provider for the Stop button
Availability.Stop = function(menu, rowIdx, rowData)
	return rowData[1] == "active" and (rowData[2][8] > 0 and rowData[2][8] < 3) 
end
