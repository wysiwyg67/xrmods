...
menu.onShowMenu = function ()
	...
	menu.ShipSetup.trader = 		menu.param[6]
...
--	if 0 < menu.ShipSetup.ShipSettings[2] then
--		table.insert( cells, LibMT:Cell("YES", nil, 1))
--	else
--		table.insert( cells, LibMT:Cell("NO", nil, 1))	
--	end
...
Buttons.Back = function()
	...
	Helper.closeMenuForSection(menu, false, "gMT_ShipMenu_ShipSetupReturn", { 0, 0, {}, {"","","",""}, {}, menu.ShipSetup.trader, {} })
	menu.cleanup()
	return
end
...
Buttons.ToggleWPAddList = function()
	if 0 < menu.ShipSetup.ShipSettings[2] then
		menu.ShipSetup.ShipSettings[2] = 0
	else
		menu.ShipSetup.ShipSettings[2] = 1
	end
	menu.display()
	return
end
